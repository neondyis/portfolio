            ...
            <Center>
                <Container>
                    ...
                    <Flex flexDirection='column' gap={4}>
                        ...
                        <ProjectCard name={'Zulf'} description={'A CMS and dashboard application for Zulf Autohouse'} categories={['React','NodeJs','MongoDB','SocketIO']} imgUrl={'https://i.ibb.co/8jgCX3F/zulf.png'}></ProjectCard>
                        <ProjectCard name={'Sticky Note'} description={'Create a history of sticky notes'} categories={['React','Java','SpringBoot','MongoDB']} imgUrl={'https://i.ibb.co/0M0NNbD/sticky.png'} projectLink={'https://note-front-gamma.vercel.app/'}></ProjectCard>
